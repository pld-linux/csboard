...
CSBoard jest małym frontendem do gnuchess. Został napisany w języku C#
i wykorzystuje mono oraz bibliotekę gtk-sharp. Jest prosty, ale
pozwala na grę w szachy z wykorzystaniem grafiki wektorowej SVG i
natywnym wyglądem oraz użyciem motywu pulpitu.

CSBoard jako silnik gry wykorzystuje gnuchess, ale można grać także
przy użyciu crafty of phalanx.
